...
namespace Com.TheFallenGames.OSA.Core
{
	...
	public class Snapper8 : MonoBehaviour
	{
		...
		public int LastSnappedItemIndex { get { return _LastSnappedItemIndex; } }
		...
		internal void StartSnappingIfNeeded()
		{
			...
			//Debug.Log("ItemIndex " + middle.ItemIndex);
			...
			//Debug.Log("indexToSnapTo: " + indexToSnapTo);
		...
		public void SmoothScrollTo(int indexToSnapTo, float snapDuration, Action onDone = null)
		{
