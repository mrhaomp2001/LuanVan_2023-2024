...
namespace Com.TheFallenGames.OSA.Demos.Common
{
	...
	{
		public const string OSA_PATH_RELATIVE_TO_PROJECT = OSAConst.OSA_PATH_IN_PROJECT;
		public const string OSA_SCENES_PATH_RELATIVE_TO_PROJECT = OSAConst.OSA_PATH_IN_PROJECT + "/" + SCENES_FOLDER_NAME;
		public const string OSA_SCENES_PATH_RELATIVE_TO_ASSETS = OSAConst.OSA_PATH_IN_ASSETS + "/" + SCENES_FOLDER_NAME;
