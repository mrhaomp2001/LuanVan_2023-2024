    ...
    <div class="container-fluid px-4">
        <div class="bg-secondary rounded p-4 ">
            ...
            <form wire:submit="save">
                ...
                @endfor
                <button class="form-floating btn btn-success" type="submit"><i class="fa-solid fa-pen-to-square me-2"></i>Sửa</button>
                @if ($question->question_status_id == 1)
                    <button wire:click="delete" class="form-floating btn btn-danger"><i class="fa-solid fa-trash-can me-2"></i>Xóa</button>
                @else
                    <button wire:click="restore" class="form-floating btn btn-outline-info"><i class="fa-solid fa-reply me-2"></i>Khôi phục</button>
                @endif
            </form>
        </div>
        @if ($errors->any())
