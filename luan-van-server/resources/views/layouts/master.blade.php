                ...
                <div class="navbar-nav w-100">
                    @if (Auth::check())
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="nav-item nav-link btn w-100 text-start ">
                                <i class="fa-solid fa-arrow-right-from-bracket me-2 ms-2"></i>Đăng xuất
                            </button>
                        </form>
                        {{-- <a href="{{ route('logout') }}" class="nav-item nav-link mx-2"><i class="fa-solid fa-arrow-right-from-bracket me-2"></i>Đăng xuất</a> --}}
                    @else
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Hội học thuật</a>, All Right Reserved.
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Mẫu CSS này
                            <br>Thiết kế bởi <a href="https://htmlcodex.com">HTML Codex</a>
                            <br>Được phát hành miễn phí bởi: <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
                        </div>
                    </div>
                </div>
            </div>
