...
namespace Library
{
    ...
    public abstract partial class JSONNode
    {
        ...
        public virtual double AsDouble
        {
            get
            {
                ...
                {
                    long parsedInt;
                    Int64.TryParse(Value, out parsedInt);
                    return parsedInt;
                }
                double parsedDouble = 0.0;
                //use invariant number format to parse double
                Double.TryParse(Value, System.Globalization.NumberStyles.Float, System.Globalization.NumberFormatInfo.InvariantInfo, out parsedDouble);
                return parsedDouble;
    ...
    public partial class JSONArray : JSONNode
    {
        ...
        public override JSONNode Copy()
        {
            JSONNode dict = new JSONArray();
            foreach (JSONNode N in m_List)
            {
                dict.Add(N);
            }
