...
namespace Com.TheFallenGames.OSA.Util.PullToRefresh
{
    ...
    public class PullToRefreshBehaviour : MonoBehaviour, IScrollRectProxy, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        [SerializeField] private bool allowPullFromStart;
        /// <summary></summary>
        [SerializeField]
...
#pragma warning restore 0649
        ...
        public UnityEvent onPullFromStart, onPullFromEnd;
        #endregion
...
#pragma warning restore 0067
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            if (!allowPullFromStart && dragAmountNorm > 0d)
                return;
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (proceedRefresh)
            {
                ...
                if (allowPullFromStart && dragAmount > 0d)
                {
                    onPullFromStart.Invoke();
                }

                if (_AllowPullFromEnd && dragAmount < 0d)
                {
                    onPullFromEnd.Invoke();
                }
            }
            else
            {
